...
public class RandomStr
{
        ...
        else if (singles)
        {
            ...
            if (upper.size() == 3)
            {
                ...
                for (int i = 0; i < length.intValue(); i++)
                {
                    ...
                    // the choice a little more random select a number out of 100 get a random number
    ...
    public static void main(String[] args)
    {
    	/* RandomStr.setCharset("0-9");
         ...
         RandomStr.setLength("6"); //指定字符长度
         try
         {
             RandomStr.generateRandomObject();//生成随机数
         }
         catch (Exception e)
         {
             // TODO 自动生成 catch 块
    ...
    /*	for(int i=0;i<=200;i++){
	        //System.out.println(RandomStr.getRandom());//得到一个随机数
	        //System.out.println(getRandom());
    		System.out.println(generateNumString(6));
	    }
    	*/
    	System.out.println(generateNumString(6));
    }
