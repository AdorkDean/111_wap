...
public class TLeaderGoodsRecommendExample  extends BaseModel{

    protected String orderByClause;

    protected List oredCriteria;

    public TLeaderGoodsRecommendExample() {
        oredCriteria = new ArrayList();


    }

    protected TLeaderGoodsRecommendExample(TLeaderGoodsRecommendExample example) {
