...
public class TGoodFreightExample  extends BaseModel{

    protected String orderByClause;

    protected List oredCriteria;

    public TGoodFreightExample() {
        oredCriteria = new ArrayList();


    }

    protected TGoodFreightExample(TGoodFreightExample example) {
    ...
    public static class Criteria {
        ...
        public Criteria andFreightIdIn(List values) {
        ...
        public Criteria andFreightIdNotIn(List values) {
