...
<body>
<header class="header">
    <a href="${base}/leader/leader!leader.action" class="iconfont top-left-btn">B</a>
    <h2 class="header-title">申请提现</h2>
    <a href="${base}/member/amountout!list.action" class="iconfont top-right-btn"><span>账单</span></a>
</header>
