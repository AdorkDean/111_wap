...
<header class="header">
    ...
    <h2 class="header-title header-title-color">秀粉排行榜</h2>
</header>
            ...
            <div class="sort-part clearfix">
                <div class="sort-name clearfix">
                    ...
                    <div class="total-num">
                        ...
                        <em class="total-icon">${tleader.people_ranking?default(99999)}</em>
                    </div>
                </div>
                <p class="sort-num"><strong>${tleader.count}</strong>秀粉</p>
            </div>
        </li>
