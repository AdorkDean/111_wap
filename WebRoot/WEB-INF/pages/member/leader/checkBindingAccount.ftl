...
<article class="health-in-money">
    ...
    <h2 class="choice-way-tips"><b></b>温馨提示：<span>为保障交易安全请先绑定您的帐号</span></h2>
        <div class="choice-way-btn clearfix">
            ...
            <ul class="clearfix">
            	<li>
                	<a href="JavaScript:void(0)" onclick="javascript:isBindingAmount('2')"><b>银行卡</b><img src="${base}/web/images/new-health/bank_card.png"></a>
                </li>
                <li>
                	<a href="JavaScript:void(0)" onclick="javascript:isBindingAmount('1')"><b>支付宝</b><img src="${base}/web/images/new-health/ali_pay.png"></a>
                </li>
            </ul>
        </div>
    </div>
...
function isBindingAmount(numberType)
{		
		$.ajax({
