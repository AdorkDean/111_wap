...
<head>
	...
	.clearfix {position:relative;border-bottom:#e6e6e6 1px solid;padding-bottom:5px;padding-top:5px;}
	...
	.rcm-list dl{overflow: hidden;}
	.rcm-img{width:125px; height:125px; display: block; float:left;}
	.rcm-img a,.rcm-img a img{width:125px; height:125px; display: block;}
	.rcm-text{margin-left:138px;}
	.rcm-list dl:first-child .rcm-text{border-top:none;}
	.shopping-name{width:90%;font-size:12px;color:#888;font-weight:bold;line-height:18px;height:20px;overflow:hidden;margin-top:5px;white-space:nowrap;text-overflow:ellipsis;-o-text-overflow:ellipsis;overflow: hidden;}
	.sales-promotion{width:90%;font-size:12px;color:#888;font-weight:bold;line-height:10px;height:20px;overflow:hidden;margin-top:5px;white-space:nowrap;text-overflow:ellipsis;-o-text-overflow:ellipsis;overflow: hidden;}
	.shopping-norms{font-size:12px; color:#808080;line-height:10px;height:20px;}
	.shopping-price {width:100%;height:20px;line-height:20px;margin-top:20px;}
	.shopping-price span {float:left; font-size:12px;color:#e60116;}
	.shopping-price span i{font-style:normal;font-size:18px; }
	.shopping-price a{float:right; display:block; height:20px; line-height:20px; border-radius: 4px; padding:0 6px; margin-right:5px; text-align: center; color:#FFF; font-size:12px; background: #e60116;margin-right:10px;}
    ...
    .line-fenge {width:100%;height:10px;background:#f5f6f7;}
    .wx-img {background:#f5f6f7;text-align:center;padding-top:5px;}
    .wx-img img {width:30%;height:30%;border-radius:10px;}
    </style>
...
<article class="recommend-shopping">
    <div class="rcm-list" id="tuijianContent">
        ...
        <dl class="clearfix" id="goods_${resc_index+1}">
            <dt class="rcm-img"><a><img src="${ui1}${resc.artwork_url}" alt="" height="125" width="125"/></a></dt>
            <dd class="rcm-text">
                <p class="shopping-name">${resc.shortname?default('')}我十四号hiHi好</p>
                <p class="sales-promotion">${resc.maintitle?default('')}</p>
                <p class="shopping-norms">${resc.spec?default('')}</p>
...
<img src="http://img.zdfei.com/static/image/temp/20160905/5f7ba057eddc773d65f50cf5bb070790.jpg" style="width:100%;margin-top:15px;display:block;">
<div class="line-fenge" style="height:20px;"></div>
<p style="background:#f3f5f7;"><img src="http://img.zdfei.com/static/image/temp/20160905/85aee65feb1a88f9b14c82577c009393.jpg" style="width:100%;"></p>

<!--二维码-->
<div class="wx-img"><img src="/web/images/300.jpg" id="wx-img"/><div>
<!--说明性文字-->
<p style="background:#f3f5f7;padding-bottom:15px;"><img src="http://img.zdfei.com/static/image/temp/20160906/374a27fa741f37e00b09f2cfa2609bde.jpg"/></p>
