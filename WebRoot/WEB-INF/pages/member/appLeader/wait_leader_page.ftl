...
<body  class="login-bg" style="padding-top:20px;">
...
<article class="health-index">
    ...
    <#if tLeader?exists && tLeader.auditType?exists && tLeader.auditType==2>
    	...
    	<div class="apply-btn applying-btn" style=""><a href="../apphealthLeader/editHealthLeaderPage!editHealthLeaderPage.action?id=${tLeader.id?if_exists}" style="color:red;"><span style="color:red;padding-left:0px;">修改</span></a></div>
