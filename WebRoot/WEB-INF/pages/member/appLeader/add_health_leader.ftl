...
<body >
<header class="header" style="top: 0px; padding-top: 20px;">
...
<article class="uploading-top clearfix" style="margin-top:20px;">
    ...
    <ul class="personal-data">
        <li class="clearfix">
            <span>昵称</span>
            <div class="personal-data-text"><input maxlength="8" type="text" name="realName" placeholder="请输入您的昵称"/></div>
        </li>
        <li class="clearfix">
            <span>姓名</span>
            <div class="personal-data-text"><input maxlength="8" type="text" name="nickName" placeholder="请输入您的姓名"/></div>
        </li>
        <li class="clearfix">
            <span>性别</span>
...
<script type="text/javascript" src="${base}/web/js/app_health_leader_add.js"></script>
