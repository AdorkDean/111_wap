...
<header class="header" style="margin-top:0px;padding-top: 20px;">
    ...
    <h2 class="header-title" style="padding-top: 20px;">修改领秀</h2>
    <a href="javascript:history.go(-1);" class="iconfont top-right-btn" style="width:70px;"></a>
</header>
<article class="uploading-top clearfix">
	<form action="../apphealthLeader/saveHealthLeader!saveHealthLeader.action" id="subForm" method="post" enctype="multipart/form-data">
    <input name="phone" value="${phone?if_exists}" type="hidden"/>
    <input name="id" value="${tLeader.id?if_exists}" type="hidden"/>
    <ul class="personal-data"  style="margin-top:20px;">
        <li class="clearfix">
            <span>昵称</span>
        ...
        <li class="clearfix">
            ...
            <div class="personal-data-text">
            	<select class="single-select" name="sex" id="sex" style="float:right;">
                    <option value="<#if tLeader.sex?exists && tLeader.sex==1>1</#if>" <#if tLeader.sex?exists && tLeader.sex==1>selected</#if>>男</option>
                    <option value="<#if tLeader.sex?exists && tLeader.sex==0>0</#if>" <#if tLeader.sex?exists && tLeader.sex==0>selected</#if>>女</option>
                </select>
            </div>
        </li>
        <li class="clearfix">
    ...
    <!--<ul class="health-uploading clearfix" style="padding-top: 21px;">
        <li class="clearfix">
            <span>请上传您的头像</span>
            <div class="up-pic">
                <input type="file" accept="image/jpg,image/jpeg" name="headImage" class="divInput"/>
    ...
    <ul class="health-uploading clearfix">
        <li class="clearfix">
            <span>请上传您的资质</span>
            <div class="up-pic">
                <input class="divInput" name="leaderImage1" type="file" accept="image/jpg,image/jpeg"/>
            ...
            <div class="up-pic">
                <input class="divInput" name="leaderImage2" type="file" accept="image/jpg,image/jpeg"/>
            ...
            <div class="up-pic">
                <input class="divInput" name="leaderImage3" type="file" accept="image/jpg,image/jpeg"/>
            ...
            <div class="up-pic">
                <input class="divInput" name="leaderImage4" type="file" accept="image/jpg,image/jpeg"/>
            ...
            <div class="up-pic">
                <input class="divInput" name="leaderImage5" type="file" accept="image/jpg,image/jpeg"/>
    ...
    <ul class="health-uploading clearfix">
        <li class="clearfix">
            ...
            <div class="up-pic">
                <input class="divInput" name="cardFirst" type="file" accept="image/jpg,image/jpeg"/>
            ...
            <div class="up-pic">
                <input class="divInput" name="cardTwo" type="file" accept="image/jpg,image/jpeg"/>
...
<script type="text/javascript" src="${base}/web/js/app_health_leader_edit.js"></script>
