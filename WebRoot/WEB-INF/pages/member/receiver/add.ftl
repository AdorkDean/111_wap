...
<article class="member-main">
    ...
    <ul class="member-list">
    	<input id="isDefault" name="tmemberreceiver.isDefault" type="hidden" value="0"/>
        <li>
        	<span>收货人</span>
            <div class="for-ipt"><input type="text" id="recid" name="tmemberreceiver.receiver" placeholder="请输入收货人" value="" maxlength="9"/></div>
        </li>
        <li>
        	<span>手机号码</span>
            <div class="for-ipt"><input placeholder="请输入手机号码" id="mobile" name="tmemberreceiver.mobile" type="text" value="" maxlength="11"/></div>
        </li>
        <li>
        	<span>邮政编码</span>
            <div class="for-ipt"><input type="text" placeholder="请输入邮政编码" id="zipCode" name="tmemberreceiver.zipCode" value="" maxlength="6"/></div>
        </li>
        <li class="edit-address">
        	<span>所在地区</span>
            <div class="for-ipt address-select"><input id="areaId" name="tmemberreceiver.areaId" type="hidden" value=""/></div>
        </li>
        <li>
        	<span>详细地址</span>
            <div class="for-ipt"><input id="address" name ="tmemberreceiver.address" type="text" value="" placeholder="请输入详细收货地址" maxlength="40"/></div>
        </li>
    </ul>
